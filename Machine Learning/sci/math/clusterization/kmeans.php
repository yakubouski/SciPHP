<?php
namespace Sci\Math\Clusterization;
...
*/
     ...
     */
    protected function calculateClosestCentroid($observation, array $centroids)
    {
        $centroid_distance = [];
    ...
    {
	    return  \Sci\Math\Distance::Euclidean($point_a, $point_b);
    }
}